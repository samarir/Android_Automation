...
Mobile.setText(findTestObject('Object Repository/IS/Wound Management/Wound List/android.widget.EditText - Search by Name, MRN'),
	'92ui', 30)

Mobile.tap(findTestObject('Object Repository/IS/Wound Management/Wound List/android.widget.TextView - Current site'), 30)

Mobile.tap(findTestObject('Object Repository/IS/Wound Management/Wound List/android.widget.TextView - Current site (1)'), 30)
...
Mobile.verifyElementText(findTestObject('Object Repository/IS/Wound Management/Wound List/android.widget.TextView - No'), 'No')
...
Mobile.verifyElementText(findTestObject('Object Repository/IS/Wound Management/Wound List/android.widget.TextView - General'),
	'General')
