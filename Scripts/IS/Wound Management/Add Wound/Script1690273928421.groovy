...
Mobile.setText(findTestObject('Object Repository/IS/Wound Management/Add Wound/android.widget.EditText - Search by Name, MRN'), 
    '78ui', 30)

Mobile.tap(findTestObject('Object Repository/IS/Wound Management/Add Wound/android.widget.TextView - Current site'), 30)

Mobile.tap(findTestObject('Object Repository/IS/Wound Management/Add Wound/android.widget.TextView - Current site (1)'), 30)
