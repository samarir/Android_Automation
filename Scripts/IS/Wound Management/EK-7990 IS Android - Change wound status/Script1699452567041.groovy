...
Mobile.setText(findTestObject('Object Repository/IS/Wound Management/Change wound statues/android.widget.EditText - Search by Name, MRN'),
	'87ui', 30)
...
Mobile.tap(findTestObject('Object Repository/IS/Wound Management/Change wound statues/android.view.ViewGroup - Patient'), 30)
