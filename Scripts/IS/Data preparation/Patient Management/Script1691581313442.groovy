...
Mobile.tap(findTestObject('Object Repository/IS/Data Preparation/Patient Management/android.widget.TextView - Edit patient'), 
    30)

Mobile.setText(findTestObject('IS/Patient Management/Edit Patient/android.widget.EditText - First Name'), 'Edit', 30)

Mobile.setText(findTestObject('IS/Patient Management/Edit Patient/android.widget.EditText - Last Name'), 'Lite', 30)

Mobile.setText(findTestObject('IS/Patient Management/Edit Patient/android.widget.EditText - DOB (1)'), '09/08/1997', 30)

Mobile.tap(findTestObject('Object Repository/IS/Data Preparation/Patient Management/android.widget.TextView - Save'), 30)

Mobile.tap(findTestObject('Object Repository/IS/Data Preparation/Patient Management/android.widget.Button - OK'), 30)
...
Mobile.tap(findTestObject('Object Repository/IS/Data Preparation/Patient Management/android.widget.TextView - 25M  MRN 6767'), 
    30)

Mobile.tap(findTestObject('IS/Data Preparation/Patient Management/android.widget.ImageView - menu'), 30)

Mobile.tap(findTestObject('Object Repository/IS/Data Preparation/Patient Management/android.widget.TextView - UnFreeze patient'), 
    30)

Mobile.tap(findTestObject('IS/Data Preparation/Patient Management/android.widget.TextView - Confirm'), 30)

Mobile.tap(findTestObject('Object Repository/IS/Data Preparation/Patient Management/android.widget.ImageView (2)'), 30)
