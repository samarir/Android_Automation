...
CucumberKW.runFeatureFile('Include/features/EK-8273 IS Android - Add Assessment.feature')

Mobile.setText(findTestObject('Object Repository/IS/Wound Assessment/Add Assessment/android.widget.EditText - Search by Name, MRN'),
	'21ui', 30)

Mobile.tap(findTestObject('Object Repository/IS/Wound Assessment/Add Assessment/android.widget.TextView - Current site'), 30)
