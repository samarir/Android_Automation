...
Mobile.tap(findTestObject('IS/Synchronization and Offline Use/Automatic sync mode/android.view.ViewGroup - add patient'), 30)

Mobile.setText(findTestObject('Object Repository/IS/Synchronization and Offline Use/Automatic sync mode/android.widget.EditText - First name'), 
    'Test', 30)

Mobile.setText(findTestObject('Object Repository/IS/Synchronization and Offline Use/Automatic sync mode/android.widget.EditText - Last name'), 
    'Sync', 30)

Mobile.setText(findTestObject('Object Repository/IS/Synchronization and Offline Use/Automatic sync mode/android.widget.EditText - Date of birth (ddmmyyyy)'), 
    '01/09/1990', 30)

Mobile.setText(findTestObject('Object Repository/IS/Synchronization and Offline Use/Automatic sync mode/android.widget.EditText - MRN'), 
    '00ui', 30)

Mobile.tap(findTestObject('Object Repository/IS/Synchronization and Offline Use/Automatic sync mode/android.widget.TextView - Save'), 
    30)

Mobile.verifyElementText(findTestObject('Object Repository/IS/Synchronization and Offline Use/Automatic sync mode/android.widget.TextView - Patient created successfully'), 
    'Patient created successfully')

Mobile.tap(findTestObject('Object Repository/IS/Synchronization and Offline Use/Automatic sync mode/android.widget.Button - OK'), 
    30)
...
Mobile.verifyElementText(findTestObject('Object Repository/IS/Synchronization and Offline Use/Automatic sync mode/android.widget.TextView - MRN 00ui'), 
    'MRN: 00ui')

Mobile.tap(findTestObject('IS/Synchronization and Offline Use/Automatic sync mode/android.widget.TextView - MRN 00ui'), 30)
...
Mobile.verifyElementExist(findTestObject('Object Repository/IS/Wound Management/Add Wound/android.view.ViewGroup (2)'), 30)

Mobile.tap(findTestObject('IS/Wound Management/Add Wound/android.view.ViewGroup (2)'), 30)
...
Mobile.tap(findTestObject('Object Repository/IS/Wound Assessment/Add Assessment/android.widget.TextView - WOUND EDGE'), 30)
...
Mobile.tap(findTestObject('Object Repository/IS/Wound Assessment/Add Assessment/android.widget.TextView - DRAINAGE'), 30)

Mobile.tap(findTestObject('Object Repository/IS/Wound Assessment/Add Assessment/android.widget.TextView - Minimum'), 30)

Mobile.tap(findTestObject('IS/Wound Assessment/Add Assessment/android.widget.TextView - DRAINAGE'), 30)
...
Mobile.tap(findTestObject('Object Repository/IS/Wound Assessment/Add Assessment/android.widget.TextView - ODOR'), 30)
...
Mobile.verifyElementExist(findTestObject('IS/Synchronization and Offline Use/Automatic sync mode/android.widget.ImageView - add treatment'), 
    30)

Mobile.tap(findTestObject('IS/Synchronization and Offline Use/Automatic sync mode/android.widget.ImageView - add treatment'), 
    30)
...
Mobile.tap(findTestObject('Object Repository/IS/Treatment and WCP/Add Treatment/android.widget.TextView - Acetic Acid'), 30)

Mobile.tap(findTestObject('Object Repository/IS/Treatment and WCP/Add Treatment/android.widget.TextView - OINTMENTS'), 30)

Mobile.tap(findTestObject('Object Repository/IS/Treatment and WCP/Add Treatment/android.widget.TextView - Zinc Oxide'), 30)
...
Mobile.tap(findTestObject('Object Repository/IS/Synchronization and Offline Use/Automatic sync mode/android.widget.TextView - MRN 00ui (1)'), 
    30)

Mobile.verifyElementExist(findTestObject('Object Repository/IS/Synchronization and Offline Use/Automatic sync mode/android.view.ViewGroup'), 
    30)

Mobile.tap(findTestObject('IS/Synchronization and Offline Use/Automatic sync mode/android.view.ViewGroup'), 30)

Mobile.tap(findTestObject('IS/Hard to find elements/android.view.ViewGroup - Assessment'), 30)

Mobile.verifyElementExist(findTestObject('Object Repository/IS/Synchronization and Offline Use/Automatic sync mode/android.view.ViewGroup (1)'), 
    30)

Mobile.tap(findTestObject('IS/Hard to find elements/android.view.ViewGroup - Treatement'), 30)

Mobile.verifyElementExist(findTestObject('Object Repository/IS/Synchronization and Offline Use/Automatic sync mode/android.view.ViewGroup (2)'), 
    30)
