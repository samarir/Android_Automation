...
CucumberKW.runFeatureFile('Include/features/EK-8781 IS iPhone - Unlock Wound.feature')
...
Mobile.tap(findTestObject('IOS/Wound Management/Unlock Wound/XCUIElementTypeOther - Unlock wound'), 30)
