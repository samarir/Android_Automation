...
Mobile.tap(findTestObject('Android/EU/Treatment Management/android.widget.TextView - Patient ID 24ui'), 30)
...
Mobile.tap(findTestObject('Object Repository/Android/IS/Treatment and WCP/Add Treatment/android.view.ViewGroup - Wound'), 
    30)
