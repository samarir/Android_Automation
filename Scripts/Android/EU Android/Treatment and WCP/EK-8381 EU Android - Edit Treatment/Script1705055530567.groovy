...
CucumberKW.runFeatureFile('Include/features/EK-8381 EU Android - Edit Treatment.feature')

Mobile.scrollToText('Patient ID: 09ui', FailureHandling.STOP_ON_FAILURE)

Mobile.tap(findTestObject('Android/EU/Treatment Management/android.widget.TextView - Patient ID 09ui'), 30)
