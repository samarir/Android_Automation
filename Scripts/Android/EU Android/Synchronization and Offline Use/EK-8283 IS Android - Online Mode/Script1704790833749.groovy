...
CucumberKW.runFeatureFile('Include/features/EK-8283 IS Android - Online Mode.feature')
...
Mobile.scrollToText('Patient ID: 12ui')

Mobile.tap(findTestObject('Android/EU/Sync/android.widget.TextView - Patient ID 12ui'), 30)
...
Mobile.tap(findTestObject('Object Repository/Android/IS/Synchronization and Offline Use/Online mode/android.view.ViewGroup (1)'), 
    30)
