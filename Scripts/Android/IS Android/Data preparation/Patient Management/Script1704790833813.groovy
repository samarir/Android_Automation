...
Mobile.tap(findTestObject('Object Repository/Android/IS/Data Preparation/Patient Management/android.widget.ImageView'), 30)
...
Mobile.setText(findTestObject('Android/IS/Patient Management/Edit Patient/android.widget.EditText - First Name'), 'Edit', 30)

Mobile.setText(findTestObject('Android/IS/Patient Management/Edit Patient/android.widget.EditText - Last Name'), 'Lite', 30)

Mobile.setText(findTestObject('Android/IS/Patient Management/Edit Patient/android.widget.EditText - DOB (1)'), '09/08/1997', 30)

Mobile.tap(findTestObject('Object Repository/Android/IS/Data Preparation/Patient Management/android.widget.TextView - Save'), 30)

Mobile.tap(findTestObject('Object Repository/Android/IS/Data Preparation/Patient Management/android.widget.Button - OK'), 30)
...
Mobile.tap(findTestObject('Object Repository/Android/IS/Data Preparation/Patient Management/android.widget.ImageView (1)'), 30)

Mobile.tap(findTestObject('Android/IS/Data Preparation/Patient Management/android.widget.Switch - Active Patients Only'), 30)

Mobile.tap(findTestObject('Object Repository/Android/IS/Data Preparation/Patient Management/android.widget.TextView - Apply'), 30)
...
Mobile.tap(findTestObject('Object Repository/Android/IS/Data Preparation/Patient Management/android.widget.ImageView (2)'), 30)
