...
CucumberKW.runFeatureFile('Include/features/EK-8398 EU Android - Automatic Sync Mode.feature')

Mobile.delay(60, FailureHandling.STOP_ON_FAILURE)

Mobile.toggleWifi('off', FailureHandling.STOP_ON_FAILURE)

Mobile.tap(findTestObject('IS/Synchronization and Offline Use/Automatic sync mode/android.view.ViewGroup - add patient'), 
    30)

Mobile.setText(findTestObject('EU/Patient Management/Add Patient/android.widget.EditText - First name'), 'Test', 30)

Mobile.setText(findTestObject('EU/Patient Management/Add Patient/android.widget.EditText - last name'), 'Sync', 30)

Mobile.setText(findTestObject('EU/Patient Management/Add Patient/android.widget.EditText - Date of birth (ddmmyyyy)'), '01/09/1990', 
    30)

Mobile.setText(findTestObject('EU/Patient Management/Add Patient/android.widget.EditText - Patient ID'), '00ui', 30)
