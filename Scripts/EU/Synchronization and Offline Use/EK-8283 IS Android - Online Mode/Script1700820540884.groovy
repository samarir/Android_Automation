...
Mobile.tap(findTestObject('EU/Sync/android.widget.TextView - Patient ID 12ui'), 30)

Mobile.delay(30, FailureHandling.STOP_ON_FAILURE)

Mobile.toggleWifi('off', FailureHandling.STOP_ON_FAILURE)

Mobile.tap(findTestObject('Object Repository/IS/Synchronization and Offline Use/Online mode/android.widget.ImageView'), 
    30)
...
Mobile.tap(findTestObject('Object Repository/IS/Synchronization and Offline Use/Online mode/android.view.ViewGroup (1)'), 
    30)
