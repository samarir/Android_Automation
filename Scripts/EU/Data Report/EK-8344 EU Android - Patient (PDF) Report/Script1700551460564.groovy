...
CucumberKW.runFeatureFile('Include/features/EK-8344 EU Android - Patient (PDF) Report.feature')

Mobile.scrollToText('Patient ID: 11ui')

Mobile.tap(findTestObject('EU/Data Report/android.widget.TextView - Patient ID 11ui'), 30)
