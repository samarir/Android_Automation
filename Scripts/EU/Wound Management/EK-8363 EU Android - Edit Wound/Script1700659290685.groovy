...
Mobile.tap(findTestObject('Object Repository/IS/Wound Management/Edit Wound/android.widget.TextView - Current site (1)'), 
    30)
...
Mobile.setText(findTestObject('Object Repository/IS/Wound Management/Edit Wound/android.widget.EditText - description'), 
    'Test Description', 30)
