...
CucumberKW.runFeatureFile('Include/features/EK-8334 EU Android - About.feature')
...
Mobile.verifyElementText(findTestObject('Object Repository/IS/Menu and other services/About/android.widget.TextView - Katalon (1)'),
	'Katalon')
